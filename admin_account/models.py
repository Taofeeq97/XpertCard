...
from card.validators import ValidateImageFileExtension, ValidateimageSize
...
class CustomAdminUser(AbstractUser, PermissionsMixin):
    ...
    profile_picture = models.ImageField(upload_to='media', validators=[ValidateImageFileExtension, ValidateimageSize], blank=True, null=True)
