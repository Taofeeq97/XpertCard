# Generated by Django 4.2.3 on 2023-07-11 15:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='media', validators=[card.validators.ValidateimageSize])),
                ('role', models.CharField(max_length=100)),
                ('qr_code', models.ImageField(blank=True, null=True, upload_to='qr_code')),
                ('tribe', models.CharField(max_length=100)),
                ('card_type', models.CharField(blank=True, choices=[('Landscape1', 'Landscape1'), ('Landscape2', 'Landscape2'), ('Portrait1', 'Portrait1'), ('Portrait2', 'Portrait2')], max_length=100, null=True)),
