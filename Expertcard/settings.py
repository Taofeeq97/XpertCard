...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://web-production-9e1e.up.railway.app', 'http://127.0.0.1']
CORS_ALLOWED_ORIGINS = ['https://web-production-9e1e.up.railway.app', 'http://127.0.0.1']
